  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex flex-col items-center text-center pb-4 border-b border-gray-100 dark:border-gray-700">
        ...
        {/* Explicit Button to trigger hidden file input */}
        <button 
          type="button" 
          onClick={() => fileInputRef.current?.click()}
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mt-3">Create New Organization</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400">Organizations group your team, projects, and tasks together.</p>
      </div>
      ...
      <div className="flex justify-end space-x-3 pt-4">
        ...
        <Button type="submit" isLoading={createOrg.isPending}>Create & Switch</Button>
      </div>
    </form>
  )
}